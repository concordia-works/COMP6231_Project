...
public class _DCMSStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.DCMS
{
  ...
  public String getRecordType (String recordID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getRecordType", true);
                $out.write_string (recordID);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
