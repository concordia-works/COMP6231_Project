...
public class _DCMSStub extends org.omg.CORBA.portable.ObjectImpl implements Ass2CORBA.DCMS
{
  ...
  public String createSRecord (String managerID, String firstName, String lastName, String coursesRegistered, String status)
  {
            ...
            try {
                ...
                return createSRecord (managerID, firstName, lastName, coursesRegistered, status        );
            } finally {
                _releaseReply ($in);
            }
  } // createSRecord
  ...
  public void startUDPServer ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("startUDPServer", true);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
