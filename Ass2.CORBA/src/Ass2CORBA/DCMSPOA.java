...
public abstract class DCMSPOA extends org.omg.PortableServer.Servant
 implements Ass2CORBA.DCMSOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("startUDPServer", new java.lang.Integer (7));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Ass2CORBA/DCMS/createTRecord
       {
       ...
       case 1:  // Ass2CORBA/DCMS/createSRecord
       {
         String managerID = in.read_string ();
         String firstName = in.read_string ();
         String lastName = in.read_string ();
       ...
       case 2:  // Ass2CORBA/DCMS/getRecordCounts
       {
         String managerID = in.read_string ();
         String $result = null;
       ...
       case 3:  // Ass2CORBA/DCMS/editRecord
       {
         String managerID = in.read_string ();
       ...
       case 4:  // Ass2CORBA/DCMS/transferRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
       ...
       case 5:  // Ass2CORBA/DCMS/printAllRecords
       {
         String managerID = in.read_string ();
         String $result = null;
       ...
       case 6:  // Ass2CORBA/DCMS/printRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
         String $result = null;
       ...
       case 7:  // Ass2CORBA/DCMS/startUDPServer
       {
         this.startUDPServer ();
         out = $rh.createReply();
         break;
